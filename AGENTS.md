...
6.
    + DO: Use the **build system** `cmake` and `make` **are explicitly ALWAYS allowed**
    + DO NOT: Use assembler and linker tools directly **without explicit permission** which require *justifiable purpose*
