...
* **Knowledge Preservation Protocol (Brain Management):** To ensure continuity across `git clone` and session boundaries, I must manage the contents of the `brain/` directory and `CHANGELOG.md` without exception.
