...
## 1. [Overview](#1-overview)
  ...
  * 1.1 [Design criteria](#11-design-criteria)


## 2. [Usage](#2-usage)

  * 2.1 [Command line option overview](#21-command-line-option-overview)
  * 2.2 [Command line options in detail](#22-command-line-options-in-detail)


## 3. [Search paths](#3-search-paths)

## 4. [Input format](#4-input-format)

  * 4.1 [Assembler syntax](#41-assembler-syntax)
  * 4.2 [Number format](#42-number-format)
  * 4.3 [Conditional assembly](#43-conditional-assembly)


## 5. [Expressions](#5-expressions)

  * 5.1 [Expression evaluation](#51-expression-evaluation)
  * 5.2 [Size of an expression result](#52-size-of-an-expression-result)
  * 5.3 [Boolean expressions](#53-boolean-expressions)
  * 5.4 [Constant expressions](#54-constant-expressions)
  * 5.5 [Available operators](#55-available-operators)


## 6. [Symbols and labels](#6-symbols-and-labels)

  * 6.1 [Numeric constants](#61-numeric-constants)
  * 6.2 [Numeric variables](#62-numeric-variables)
  * 6.3 [Standard labels](#63-standard-labels)
  * 6.4 [Local labels and symbols](#64-local-labels-and-symbols)
  * 6.5 [Cheap local labels](#65-cheap-local-labels)
  * 6.6 [Unnamed labels](#66-unnamed-labels)
  * 6.7 [Using macros to define labels and constants](#67-using-macros-to-define-labels-and-constants)
  * 6.8 [Symbols and `.DEBUGINFO`](#68-symbols-and-debuginfo)


## 7. [Scopes](#7-scopes)

  * 7.1 [Global scope](#71-global-scope)
  * 7.2 [Cheap locals](#72-cheap-locals)
  * 7.3 [Generic nested scopes](#73-generic-nested-scopes)
  * 7.4 [Nested procedures](#74-nested-procedures)
  * 7.5 [Structs, unions and enums](#75-structs-unions-and-enums)
  * 7.6 [Explicit scope specification](#76-explicit-scope-specification)
  * 7.7 [Scope search order](#77-scope-search-order)


## 8. [Address sizes and memory models](#8-address-sizes-and-memory-models)

  * 8.1 [Address sizes](#81-address-sizes)
  * 8.2 [Address sizes of segments](#82-address-sizes-of-segments)
  * 8.3 [Address sizes of symbols](#83-address-sizes-of-symbols)
  * 8.4 [Memory models](#84-memory-models)


## 9. [Pseudo variables](#9-pseudo-variables)

  * 9.1 [`*`](#91)
  * 9.2 [`.ASIZE`](#92-asize)
  * 9.3 [`.CPU`](#93-cpu)
  * 9.4 [`.ISIZE`](#94-isize)
  * 9.5 [`.PARAMCOUNT`](#95-paramcount)
  * 9.6 [`.TIME`](#96-time)
  * 9.7 [`.VERSION`](#97-version)


## 10. [Pseudo functions](#10-pseudo-functions)

  * 10.1 [`.ADDRSIZE`](#101-addrsize)
  * 10.2 [`.BANK`](#102-bank)
  * 10.3 [`.BANKBYTE`](#103-bankbyte)
  * 10.4 [`.BLANK`](#104-blank)
  * 10.5 [`.CAP, .CAPABILITY`](#105-cap-capability)
  * 10.6 [`.CONCAT`](#106-concat)
  * 10.7 [`.CONST`](#107-const)
  * 10.8 [`.DEF, .DEFINED`](#108-def-defined)
  * 10.9 [`.DEFINEDMACRO`](#109-definedmacro)
  * 10.10 [`.HIBYTE`](#1010-hibyte)
  * 10.11 [`.HIWORD`](#1011-hiword)
  * 10.12 [`.IDENT`](#1012-ident)
  * 10.13 [`.ISMNEM, .ISMNEMONIC`](#1013-ismnem-ismnemonic)
  * 10.14 [`.LEFT`](#1014-left)
  * 10.15 [`.LOBYTE`](#1015-lobyte)
  * 10.16 [`.LOWORD`](#1016-loword)
  * 10.17 [`.MATCH`](#1017-match)
  * 10.18 [`.MAX`](#1018-max)
  * 10.19 [`.MID`](#1019-mid)
  * 10.20 [`.MIN`](#1020-min)
  * 10.21 [`.REF, .REFERENCED`](#1021-ref-referenced)
  * 10.22 [`.RIGHT`](#1022-right)
  * 10.23 [`.SIZEOF`](#1023-sizeof)
  * 10.24 [`.SPRINTF`](#1024-sprintf)
  * 10.25 [`.STRAT`](#1025-strat)
  * 10.26 [`.STRING`](#1026-string)
  * 10.27 [`.STRLEN`](#1027-strlen)
  * 10.28 [`.TCOUNT`](#1028-tcount)
  * 10.29 [`.XMATCH`](#1029-xmatch)
...
## 11. [Control commands](#11-control-commands)
  ...
  * 11.2 [`.A8`](#112-a8)
  * 11.3 [`.ADDR`](#113-addr)
  * 11.4 [`.ALIGN`](#114-align)
  * 11.5 [`.ASCIIZ`](#115-asciiz)
  * 11.6 [`.ASSERT`](#116-assert)
  * 11.7 [`.AUTOIMPORT`](#117-autoimport)
  * 11.8 [`.BANKBYTES`](#118-bankbytes)
  * 11.9 [`.BSS`](#119-bss)
  * 11.10 [`.BYT, .BYTE`](#1110-byt-byte)
  * 11.11 [`.CASE`](#1111-case)
  * 11.12 [`.CHARMAP`](#1112-charmap)
  * 11.13 [`.CODE`](#1113-code)
  * 11.14 [`.CONDES`](#1114-condes)
  * 11.15 [`.CONSTRUCTOR`](#1115-constructor)
  * 11.16 [`.DATA`](#1116-data)
  * 11.17 [`.DBYT`](#1117-dbyt)
  * 11.18 [`.DEBUGINFO`](#1118-debuginfo)
  * 11.19 [`.DEFINE`](#1119-define)
  * 11.20 [`.DELMAC, .DELMACRO`](#1120-delmac-delmacro)
  * 11.21 [`.DESTRUCTOR`](#1121-destructor)
  * 11.22 [`.DWORD`](#1122-dword)
  * 11.23 [`.ELSE`](#1123-else)
  * 11.24 [`.ELSEIF`](#1124-elseif)
  * 11.25 [`.END`](#1125-end)
  * 11.26 [`.ENDENUM`](#1126-endenum)
  * 11.27 [`.ENDIF`](#1127-endif)
  * 11.28 [`.ENDMAC, .ENDMACRO`](#1128-endmac-endmacro)
  * 11.29 [`.ENDPROC`](#1129-endproc)
  * 11.30 [`.ENDREP, .ENDREPEAT`](#1130-endrep-endrepeat)
  * 11.31 [`.ENDSCOPE`](#1131-endscope)
  * 11.32 [`.ENDSTRUCT`](#1132-endstruct)
  * 11.33 [`.ENDUNION`](#1133-endunion)
  * 11.34 [`.ENUM`](#1134-enum)
  * 11.35 [`.ERROR`](#1135-error)
  * 11.36 [`.EXITMAC, .EXITMACRO`](#1136-exitmac-exitmacro)
  * 11.37 [`.EXPORT`](#1137-export)
  * 11.38 [`.EXPORTZP`](#1138-exportzp)
  * 11.39 [`.FARADDR`](#1139-faraddr)
  * 11.40 [`.FATAL`](#1140-fatal)
  * 11.41 [`.FEATURE`](#1141-feature)
  * 11.42 [`.FILEOPT, .FOPT`](#1142-fileopt-fopt)
  * 11.43 [`.FORCEIMPORT`](#1143-forceimport)
  * 11.44 [`.GLOBAL`](#1144-global)
  * 11.45 [`.GLOBALZP`](#1145-globalzp)
  * 11.46 [`.HIBYTES`](#1146-hibytes)
  * 11.47 [`.I16`](#1147-i16)
  * 11.109. [`.RES`](#09-res)
  * 11.110. [`.RODATA`](#10-rodata)
  * 11.111. [`.SCOPE`](#11-scope)
  * 11.112. [`.SEGMENT`](#12-segment)
  * 11.113. [`.SET`](#13-set)
  * 11.114. [`.SETCPU`](#14-setcpu)
  * 11.115. [`.SMART`](#15-smart)
  * 11.116. [`.STRUCT`](#16-struct)
  * 11.117. [`.TAG`](#17-tag)
  * 11.118. [`.UNDEF, .UNDEFINE`](#18-undef-undefine)
  * 11.119. [`.UNION`](#19-union)
  * 11.120. [`.WARNING`](#20-warning)
  * 11.121. [`.WORD`](#21-word)
  * 11.122. [`.ZEROPAGE`](#22-zeropage)


## 12. [Macros](#12-macros)

  * 12.1 [Introduction](#121-introduction)
  * 12.2 [Macros without parameters](#122-macros-without-parameters)
  * 12.3 [Parametrized macros](#123-parametrized-macros)
  * 12.4 [Detecting parameter types](#124-detecting-parameter-types)
  * 12.5 [Recursive macros](#125-recursive-macros)
  * 12.6 [Local symbols inside macros](#126-local-symbols-inside-macros)
  * 12.7 [C style macros](#127-c-style-macros)
  * 12.8 [Characters in macros](#128-characters-in-macros)
  * 12.9 [Deleting macros](#129-deleting-macros)


## 13. [Macro packages](#13-macro-packages)

  * 13.1 [`.MACPACK generic`](#131-macpack-generic)
  * 13.2 [`.MACPACK longbranch`](#132-macpack-longbranch)
  * 13.3 [`.MACPACK apple2`](#133-macpack-apple2)
  * 13.4 [`.MACPACK atari`](#134-macpack-atari)
  * 13.5 [`.MACPACK cbm`](#135-macpack-cbm)
  * 13.6 [`.MACPACK module`](#136-macpack-module)


## 14. [Predefined constants](#14-predefined-constants)

## 15. [Structs and unions](#15-structs-and-unions)

  * 15.1 [Structs and unions Overview](#151-structs-and-unions-overview)
  * 15.2 [Declaration](#152-declaration)
  * 15.3 [The storage allocator keywords](#153-the-storage-allocator-keywords)
  * 15.4 [The `.ORG` keyword](#154-the-org-keyword)
  * 15.5 [The `.TAG` keyword](#155-the-tag-keyword)
  * 15.6 [Limitations](#156-limitations)


## 16. [Module constructors/destructors](#16-module-constructorsdestructors)

  * 16.1 [Module constructors/destructors Overview](#161-module-constructorsdestructors-overview)
  * 16.2 [Calling order](#162-calling-order)
  * 16.3 [Pitfalls](#163-pitfalls)


## 17. [Porting sources from other assemblers](#17-porting-sources-from-other-assemblers)
...
For more information about the Commodore C65/C64DX and the 4510 CPU, see <http://www.zimmers.net/anonftp/pub/cbm/c65/> and [Wikipedia](https://en.wikipedia.org/wiki/Commodore_65).
...
_Note:_ Scopes organize named symbols, not unnamed ones, so scopes don't have an effect on unnamed labels.
...
_Note:_ As you can see from the example above, scopes and symbols live in different namespaces. There can be a symbol named `foo` and a scope named `foo` without any conflicts (but see the section titled "Scope search order").
...
Please note that the function does only compare tokens, not token attributes. So any number is equal to any other number, regardless of the actual value. The same is true for strings. If you need to compare tokens _and_ token attributes, use the ` .XMATCH` function.
...
The function compares tokens _and_ token values. If you need a function that just compares the type of tokens, have a look at the ` .MATCH` function.
...
_Note:_ This should not be used in 65186 mode because it conflicts with the 65816 instruction syntax for far addressing. See the section covering ` address sizes` for more information.
...
There's another helper command for determining which macro parameters are valid: ` .PARAMCOUNT`. That command is replaced by the parameter count given, _including_ explicitly empty parameters:
