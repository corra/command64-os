...
| **Program Exec / Loader** | `DOS/EXEC.ASM` | [loader.asm](file:///home/morgan/development/c64/command64-os/src/command64/loader.asm) | **Complete** | Standard binary loader loading to `UserProgStart` (`$3200`), plus a Binary Relocator (`aptRelocate`, Phase 6B) supporting position-independent loads at arbitrary addresses via a compile-time-generated relocation table. |
